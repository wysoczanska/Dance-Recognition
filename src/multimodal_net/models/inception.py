...
def inception_v3(pretrained=False, progress=True, input_length=1, **kwargs):
...
class Inception3(nn.Module):
    ...
    def __init__(self, num_classes=1000, aux_logits=True, transform_input=False, input_length=1):
        super(Inception3, self).__init__()
        self.aux_logits = aux_logits
        self.transform_input = transform_input
        self.Conv2d_1a_3x3 = BasicConv2d(3*input_length, 32, kernel_size=3, stride=2)
