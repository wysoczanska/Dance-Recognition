...
def main():
    ...
    train_dataset = datasets.__dict__[args.dataset](args.data, args.train_split_file, "train", args.new_length,
                                                    video_transform=train_transform)
    val_dataset = datasets.__dict__[args.dataset](args.data, args.test_split_file, "val", args.new_length,
...
def build_model():
    ...
    model.classifier[6] = nn.Linear(1000, 10)
    return model
